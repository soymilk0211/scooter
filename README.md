...
SQLite 結構與種子資料庫（臺北 118 條規則、1,523 個固定測速點、
4 段全面禁行機車路段、13,102 條路的路名索引，共 1.4 MB）、定位前景服務、
語音警示與失效警告、固定測速警示、可拖曳時速圓圈、深淺兩色底圖與設定落地、
[資料管線](pipeline/README.md)。**92 項單元測試全綠**（core-rules 65、app 27）。

**導航已經接起來**（長按地圖選目的地 → BRouter 算路線 → 琥珀色路線 →
